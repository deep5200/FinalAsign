...
public class TillDelete {
	...
	public static void main(String[] args) {
		...
		// driver.findElement(By.xpath("//a[@class='menuButtonMenuLink firstMenuItem
		// eventMru']")).click();
		...
		/*
		 * driver.findElement(By.xpath("//input[@id='Attach']")).click(); String
		 * windowHandle = driver.getWindowHandle(); System.out.println(windowHandle);
		 * Set<String> windowHandles = driver.getWindowHandles();
		 * System.out.println(windowHandles.size()); List<String>windows1=new
		 * ArrayList<String>(windowHandles); driver.switchTo().window(windows1.get(1));
		 * String title1 = driver.getTitle(); System.out.println(title1);
		 * driver.switchTo().window(windows1.get(0));
		 * driver.findElement(By.xpath("(//input[@class='btn'])[2]")).click();
		 * driver.findElement(By.name("save")).click(); Thread.sleep(2000);
